...
```{r}
list.files("salmon_quant/SRR1552444/")
```
...
```{r}
gtf_file <- "ensembl_ref/Mus_musculus.GRCm38.91.chr.gtf.gz"
...
Here is a small, completely unrelated, example.
