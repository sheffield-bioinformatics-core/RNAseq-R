---
title: "Working with fastq files; Quality Assessment, alignment and counting"
author: "Mark Dunning"
...
--gcBias  -r fastq_files/SRR1552444.fastq.gz -o quant/SRR1552444
...
```{bash}
mkdir aligned_reads
wget ftp://ftp.ensembl.org/pub/release-91/fasta/mus_musculus/dna/Mus_musculus.GRCm38.dna.chromosome.19.fa.gz -P ensembl_ref/
gunzip ensembl_ref/Mus_musculus.GRCm38.dna.chromosome.19.fa.gz
hisat2-build ensembl_ref/Mus_musculus.GRCm38.dna.chromosome.19.fa.gz hisat_ref/GRCm38_chr19_hisat
hisat2 -q -x hisat_ref/GRCm38_chr19 fastq_files/SRR1552444.fastq.gz -S aligned_reads/SRR1552444.sam
...
[DESeq2 tutorial from Bioconductor 2018 conference](https://bioconductor.github.io/BiocWorkshops/rna-seq-data-analysis-with-deseq2.html)
