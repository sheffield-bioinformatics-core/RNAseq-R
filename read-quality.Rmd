...
```{bash eval=FALSE}
wget sbc.shef.ac.uk/example_reads.fastq
```
...
```{bash eval=FALSE}
wget sbc.shef.ac.uk/read_archive.tar.gz
## example of how to extract into folders
## challenge of compressed one of the files?
```
...
Can put files on shared drive, and it will be accessible

### Getting files from SRA?
